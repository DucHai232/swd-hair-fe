...
const PaymentBooking = ({ responseAppointment, setIsPayment }) => {
    ...
    try {
      const newPayment = {
        amount:
          ...
          (priceDiscount ||
            (responseAppointment.totalPrice * (discountCoupon || 0)) / 100),
  ...
  const renderVoucher = (data) => {
    ...
    return (
      <Card className={styles.cardVoucher}>
        ...
        <Col span={8}>
          <Row>
            ...
            <Col span={12}>
              ...
              >
                {responseAppointment.totalPrice.toLocaleString()}đ
              </span>
            </Col>
          </Row>
            ...
            <>
              <Row>
                ...
                <Col span={12}>
                  ...
                  >
                    {priceDiscount.toLocaleString()}đ
                  </span>
                </Col>
              </Row>
            </>
            ...
            <>
              <Row>
                ...
                <Col span={12}>
                  ...
                  >
                    {(responseAppointment.totalPrice * discountCoupon) / 100}đ
                  </span>
                </Col>
              </Row>
            </>
              ...
              <Col span={12}>
                ...
                >
                  {(
                    responseAppointment.totalPrice -
                    (priceDiscount ||
                      (responseAppointment.totalPrice * (discountCoupon || 0)) /
                        100)
                  ).toLocaleString()}
                  đ
                </span>
        ...
        <>
          <Row gutter={[12, 12]} justify={"center"} style={{ width: "100%" }}>
            <List
              ...
              footer={
                <Row>
                  <Col span={24}>{renderCalculator()}</Col>
                  <Col span={24}>
                    <Button
                      variant="contained"
                      type="danger"
