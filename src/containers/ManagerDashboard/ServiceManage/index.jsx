...
import { useCreateServiceMutation, useDeleteSoftServiceMutation, useUpdateServiceMutation, useViewServiceQuery } from '../../../services/hairsalon.service';
    ...
    <div className={styles.serviceManageContainer}>
      ...
      >
        <Form form={form} onFinish={handleFinish} layout="vertical">
          ...
          <Form.Item label="Loyalty Points" name="loyaltyPoints" rules={[{ required: true, message: 'Please input the Loyalty Points!' }]}>
            <Input type="number" />
          </Form.Item>
          ...
          <Form.Item label="Active" name="active" rules={[{ required: true, message: 'Please select the active status!' }]}>
            <Radio.Group>
